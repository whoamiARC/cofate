...
export const SCRIPT_CATALOG: ScriptCatalogItem[] = [
  ...
  { id: "absent-guest", mark: "宴", title: "缺席者的晚宴", tagline: "多出来的餐具，属于谁？", theme: "朋友聚会多出一套餐具，所有合照里都站着一个没人认识的人", category: "聚会", players: "4—8 人", duration: "30 分钟", price: 0, tone: "violet", featured: true, plan: storyPlan(7, "调查多出的餐具、座位和合照，收集关于缺席者的矛盾记忆。", "拼出缺席者与每个人的关系，并确认是谁主动删除了这段记忆。", "共同表决让缺席者回来、彻底遗忘，或由一人替代其席位。", "最后一次席位表决完成，空椅接受结果；第7回合强制结束晚宴。") },
  ...
  { id: "tidal-promise", mark: "岛", title: "潮汐失约", tagline: "退潮以后，门从海里出现。", theme: "海岛民宿被大雾封住，退潮后沙滩上出现了写着每个人名字的房门", category: "轻悬疑", players: "3—6 人", duration: "35 分钟", price: 0, tone: "mint", plan: storyPlan(7, "调查写有名字的房门，发现每扇门对应的一次失约。", "让玩家面对、交换或隐瞒自己的旧承诺，拼出海岛封锁的原因。", "决定打开、封闭或交换房门，并共同处理最早的那次失约。", "潮水重新覆盖所有房门，且众人完成选择；第7回合必然涨潮。") },
  ...
  { id: "silent-library", mark: "书", title: "闭馆后的借阅者", tagline: "归还一本从未借出的书。", theme: "大学图书馆闭馆后，借阅系统显示在场每个人都借过一本记录自己未来的书", category: "校园", players: "2—6 人", duration: "25 分钟", price: 0, tone: "amber", plan: storyPlan(6, "找到各自的未来之书，确认书中预言与现实的对应关系。", "交换部分未来、验证管理员规则，并找出那本没有借阅者的书。", "决定归还、交换、改写或销毁未来之书。", "所有书籍得到处置且借阅系统结算；第6回合图书馆强制闭馆。") },
  ...
  { id: "parallel-call", mark: "电", title: "来自另一条线的电话", tagline: "电话那头，是五分钟后的你。", theme: "两个人同时接到来自彼此号码的电话，电话中的声音却提前说出了五分钟后发生的事", category: "双人", players: "2 人", duration: "20 分钟", price: 0, tone: "violet", plan: storyPlan(5, "验证电话中的三个未来细节，区分预言与诱导。", "找出时间循环由谁触发，以及哪一次行动会让另一人消失。", "两人同时执行或拒绝最后一条电话指令。", "五分钟时间差闭合，两人完成同步选择；第5回合强制断线。") },
  { id: "museum-night", mark: "藏", title: "博物馆失窃之夜", tagline: "丢失的展品，从未被展出。", theme: "私人博物馆停电后，所有人收到通知：一件不存在于目录中的展品被盗了", category: "聚会", players: "4—8 人", duration: "35 分钟", price: 0, tone: "blue", plan: storyPlan(7, "搜查展厅、目录与停电记录，确认不存在展品留下的痕迹。", "找出偷窃者、动机与伪造目录的人，让角色利益公开冲突。", "公开指认、帮助隐藏展品，或承认展品本就是某个人。", "最终指认完成且停电结束；第7回合保安系统自动封馆。") },
  ...
  { id: "mirror-shift", mark: "镜", title: "镜面夜班", tagline: "镜子里的同事，早你一步下班。", theme: "写字楼夜班期间，镜子里的所有人开始比现实快一步行动，门禁记录却显示无人加班", category: "都市", players: "3—6 人", duration: "30 分钟", price: 0, tone: "acid", plan: storyPlan(7, "记录镜像与现实的时间差，确认至少三处提前发生的动作。", "找出谁已被镜像替换，以及门禁记录中消失的真实时间。", "决定打碎、交换或同步镜面世界，并选择保留哪一个版本。", "现实与镜像只剩一个稳定版本；第7回合镜面完成替换。") },
  ...
  { id: "empty-room", mark: "空", title: "多出来的房间", tagline: "这间房，记得你们所有人。", theme: "民宿平面图突然多出一个房间，房内摆放着每位住客童年时丢失的一件东西", category: "聚会", players: "3—8 人", duration: "35 分钟", price: 0, tone: "amber", plan: storyPlan(7, "调查房间、遗失物与平面图，确认物品为何认识现在的主人。", "揭示物品交换造成的记忆缺口，找出房间真正想留下的人。", "取回、交换或放弃遗失物，并决定封闭还是保留房间。", "每件遗失物得到归属且房门接受决定；第7回合房间从平面图消失。") },
  ...
  { id: "night-exam", mark: "考", title: "无人参加的补考", tagline: "答错的人，会忘记一道真实经历。", theme: "深夜教学楼亮起一间考场，试卷上的每一道题都来自参与者共同经历却没人承认的往事", category: "校园", players: "3—6 人", duration: "30 分钟", price: 0, tone: "violet", plan: storyPlan(6, "回答个人经历题目，比较不同答案并记录被扣除的记忆。", "找出被集体遗忘的共同事件，以及出题者希望众人否认的真相。", "共同提交最终答案，或选择由一人承担全部遗忘。", "交卷并完成记忆代价判定；第6回合铃响后强制收卷。") },
  ...
  { id: "ascension-list", mark: "仙", title: "飞升候补名单", tagline: "天门只开一次，名单却有七份。", theme: "修行界公布本年度唯一飞升名额，在场每个人都拿到一份写着自己名字的真名单，而负责审核的仙鹤坚称自己今天第一天上班", category: "古风", players: "3—7 人", duration: "30 分钟", price: 0, tone: "rose", plan: storyPlan(6, "检验七份名单、功德记录与天门印章，完成第一轮候补陈述。", "揭示每个人飞升或留下的真实理由，查清名额制度为何同时选择所有人。", "推选一人、集体拒绝或改写飞升规则，并承担天门给出的代价。", "飞升名额得到最终处理且天门接受结果；第6回合天门无条件关闭。") },
  ...
  { id: "empty-sunrise", mark: "晨", title: "日出后的无人城市", tagline: "预言失败了，人却都不见了。", theme: "所有人躲过预言中的末日后走出避难所，城市完好无损却空无一人，公共屏幕正在直播他们昨天没有做出的选择", category: "末日", players: "2—6 人", duration: "30 分钟", price: 0, tone: "blue", plan: storyPlan(6, "探索完整却无人的街区，核对避难记录与公共屏幕上的另一条时间线。", "找出居民消失与众人昨日选择的关系，确认哪座广播塔能联系另一条城市。", "选择召回居民、进入另一条时间线或让两座城市交换幸存者。", "城市人口归属得到决定且广播塔完成一次传输；第6回合两条时间线分离。") },
  ...
  { id: "boss-group-chat", mark: "群", title: "全员误入老板群", tagline: "撤回失败，汇报还有五分钟。", theme: "项目组吐槽群突然与老板群合并，所有历史消息都变成了待办事项，而真正的汇报文件却被系统拆成碎片发给每个人", category: "喜剧", players: "3—8 人", duration: "20 分钟", price: 0, tone: "acid", plan: storyPlan(5, "认领聊天记录与文件碎片，判断哪些消息必须解释、撤回或将错就错。", "拼出真正的汇报方案，在误会升级时分配临时职位并说服关键成员。", "完成五分钟汇报，选择坦白群聊事故或把它包装成团队创新。", "汇报完成且老板给出最终回复；第5回合会议室自动接通。") },
  ...
  { id: "snow-manor-switch", mark: "画", title: "雪山庄园无伤案", tagline: "没有受害者，人人都有动机。", theme: "暴雪封住庄园后，主人宣布名画被替换成赝品，奇怪的是每个人都承认自己曾在同一晚偷偷保护过那幅画", category: "推理", players: "4—8 人", duration: "30 分钟", price: 0, tone: "blue", plan: storyPlan(7, "搜查画室、壁炉与运输记录，建立每个人接触名画的时间线。", "拆解互相重叠的保护计划，找出真画、赝品与第三幅练习稿的流转顺序。", "公开完整推理，决定将真画归还、捐赠或继续隐藏。", "画作去向和替换链条得到一致解释；第7回合山路恢复通行。") },
